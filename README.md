...
* There's a *ton* of manual effort in setting up a realsense camera on raspi. If you get frame dropping issues on init, see [patching uvcvideo](https://eleccelerator.com/wiki/index.php?title=Raspbian_Buster_ROS_RealSense#Patching_uvcvideo). Also [installing realsense](https://eleccelerator.com/wiki/index.php?title=Raspbian_Buster_ROS_RealSense#Installing_librealsense) for the main instructions.
