...
docker run --rm --net=l2  l2sim:latest bash -i -c "PYTHONUNBUFFERED=1 ros2 service call /spawn_entity 'gazebo_msgs/SpawnEntity' \"$ENT\""

# No longer necessary now that syncing is done via postgresql.
